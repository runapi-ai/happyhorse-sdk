...
Dir.chdir(__dir__) do
  ...
  Gem::Specification.new do |spec|
    ...
    spec.version = "0.2.7"
    spec.metadata["runapi_slug"] = "happyhorse"
    spec.authors = ["RunAPI"]
    spec.email = ["contact@runapi.ai"]

    spec.summary = "HappyHorse API Ruby SDK for RunAPI"
    spec.description = "The HappyHorse Ruby SDK is the language-specific package for HappyHorse on RunAPI. Use this package for video generation, animation, and video editing workflows when your application needs request bodies, task status lookup, and consistent RunAPI errors in Ruby."
    ...
    spec.metadata["bug_tracker_uri"] = "https://github.com/runapi-ai/happyhorse-sdk/issues"
